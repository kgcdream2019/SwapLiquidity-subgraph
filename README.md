...
Contains data across all of Uniswap V2. This entity tracks important things like total liquidity (in BNB and USD, see below), all time volume, transaction count, number of pairs and more.
